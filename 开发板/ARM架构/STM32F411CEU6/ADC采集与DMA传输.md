...
![[assets/ADC采集与DMA传输/file-20260421201559953.png]]
...
#### 辅助图示
 ...
 1. [[ADC]] 采集流程 ![[assets/ADC采集与DMA传输/file-20260421201559956.png]]
 2. [[ADC]] 框图 ![[assets/ADC采集与DMA传输/file-20260421201559960.png]]
3. 流水线 [[ADC]]
![ADC转换过程](https://i-blog.csdnimg.cn/blog_migrate/9d4a4b1bb33af4336ccba96adb8db55b.png)![[assets/ADC采集与DMA传输/file-20260421201559968.png]]

4. 逐次比较型 [[ADC]] ![[assets/ADC采集与DMA传输/file-20260421201559972.png]]
5. 并行比较型 [[ADC]] ![[assets/ADC采集与DMA传输/file-20260421201559976.png]]
6. ∑-Δ型 ![[assets/ADC采集与DMA传输/file-20260421201559979.png]]
7. 积分型 [[ADC]]![[assets/ADC采集与DMA传输/file-20260421201559953.png]](https://i-blog.csdnimg.cn/blog_migrate/2fa0de08cf63e16095b919eab1c2d450.png)![[assets/ADC采集与DMA传输/file-20260421201559983.png]]
8. [[ADC]] 输入电压范围 ![[assets/ADC采集与DMA传输/file-20260421201559987.png]]
9. 单端输入
 ![[assets/ADC采集与DMA传输/file-20260421201559953.png]](https://i-blog.csdnimg.cn/blog_migrate/d215b3b908f490aa614c7e28041ec672.png)
10. 差分输入
![[assets/ADC采集与DMA传输/file-20260421201559953.png]](https://i-blog.csdnimg.cn/blog_migrate/09a614839cbcd78868f64ca13fd896d7.png)
...
1. 系统总线矩阵 ![[assets/ADC采集与DMA传输/file-20260421201559992.png]]
2. DMA 整体结构框图 ![[assets/ADC采集与DMA传输/file-20260421201559997.png]]
3. DMA 与总线的链接图 ![[assets/ADC采集与DMA传输/file-20260421201600002.png]]
4. 不同通道和不同数据流的 DMA 请求 ![[assets/ADC采集与DMA传输/file-20260421201600008.png]] ![[assets/ADC采集与DMA传输/file-20260421201600016.png]]
5. FIFO 和仲裁器 ![[assets/ADC采集与DMA传输/file-20260421201600022.png]] ![[assets/ADC采集与DMA传输/file-20260421201600027.png]]
6. FIFO 和 Burst ![[assets/ADC采集与DMA传输/file-20260421201600033.png]]
7. DMA 中断请求 ![[assets/ADC采集与DMA传输/file-20260421201600039.png]]
...
1. Draw 程序架构逻辑图 ![[assets/ADC采集与DMA传输/file-20260421201600043.png]]
2. 代码静态分析图 ![[assets/ADC采集与DMA传输/file-20260421201600048.png]]
3. 代码内存窗口 ![[assets/ADC采集与DMA传输/file-20260421201600052.png]]
4. RTT 观察窗口 ![[assets/ADC采集与DMA传输/file-20260421201600056.png]]
...
A 7: EOCSelection 参数是来选择 [[ADC]] 转换一个发送一个还是全部转换完毕再发送 ![[assets/ADC采集与DMA传输/file-20260421201600060.png]] 位于 ADC_CR 2 寄存器上

### Q 8：ADC 采样为什么采样时间越长越准确？能从 ADC 的构造解释一下吗？

A 8: [[ADC]] 采样时间取决于采样电路的电容充电时间，==所有的通道共用一个采样保持电容== ![[assets/ADC采集与DMA传输/file-20260421201600065.png]] 当采样时间不够时，Cadc 上的电压与 Vain 不一致会导致转换结果偏大 ![[assets/ADC采集与DMA传输/file-20260421201600070.png]]
