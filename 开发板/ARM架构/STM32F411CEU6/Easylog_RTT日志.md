...
![[assets/Easylog_RTT日志/file-20260421201558892.png]]
...
1. 找到所需的库文件 ![[assets/Easylog_RTT日志/file-20260421201558895.png]]
2. 需要放入工程的文件 （注意库引用）![[assets/Easylog_RTT日志/file-20260421201558898.png]]
3. 移植第一个问题 （删除注释即可）![[assets/Easylog_RTT日志/file-20260421201558901.png]]
4. RTT 缓冲区大小配置 ![[assets/Easylog_RTT日志/file-20260421201558905.png]]
5. 串口重定向修改（还需要添加头文件# include "SEGGER_RTT.h"）![[assets/Easylog_RTT日志/file-20260421201558910.png]]
6. 设置输出端口和输出文本颜色 ![[assets/Easylog_RTT日志/file-20260421201558915.png]]
7. RTT 输出浮点数 ![[assets/Easylog_RTT日志/file-20260421201558918.png]] ![[assets/Easylog_RTT日志/file-20260421201558922.png]]
8. 查看窗口 ![[assets/Easylog_RTT日志/file-20260421201558926.png]]
9. RTT 实现机制 ![[assets/Easylog_RTT日志/file-20260421201558929.png]]
...
1. 需要下载的文件夹 ![[assets/Easylog_RTT日志/file-20260421201558932.png]]
