...
1. Spi 系统框图 ![[assets/SPI/file-20260504154449037.png]]
2. Spi 的硬件引脚接线图 ![[assets/SPI/file-20260504160432376.png]]
3. Spi 多种模式时序图 ![[assets/SPI/file-20260504195617533.png]]
4. ==从模式下上拉速率的计算 ==![[assets/SPI/file-20260504201100047.png]]
5. 从模式下传输数据时序图 ![[assets/SPI/file-20260504201221017.png]]
6. 主模式下传输数据时序图 ![[assets/SPI/file-20260504201825517.png]]
7. Spi 主机在全双工模式下的数据传输时序图 ![[assets/SPI/file-20260504202612259.png]]
8. Spi 主从机在半双工模式下的只发送模式数据传输时序图 ![[assets/SPI/file-20260504203048493.png]]
9. Spi 主从机在半双工模式下的只接收模式数据传输时序图 ![[assets/SPI/file-20260504203155085.png]]
10. Spi 在开启 DMA 数据传输时序图 ![[assets/SPI/file-20260504203713502.png]] ![[assets/SPI/file-20260504203735265.png]]
11. SPI 中断请求 ![[assets/SPI/file-20260504215854655.png]]
